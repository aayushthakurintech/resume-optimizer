...
// ---- Lazy-load PDF.js only in the browser ----
let _pdfjs: any = null;
...
async function extractFromDOCX(file: File): Promise<string> {
  const buf = await file.arrayBuffer();
  const mod: any = await import('mammoth'); // client-side only
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 space-y-6">
        ...
        <header className="space-y-2">
          ...
          <p className="text-slate-300 max-w-3xl">
            Attach your resume below. You can edit extracted text before running the review.
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8 space-y-6">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              {/* Drop zone (changes color on hover) */}
              <label
                htmlFor="resume"
              ...
              >
                ...
                <span className="mt-1 text-xs text-slate-400">
                  Max ~10 MB • Client-side extraction
                </span>
                <input
                  id="resume"
                  type="file"
          ...
          <details className="pt-2">
            <summary className="cursor-pointer text-sm text-slate-300">
              Optional: Job Description (improves tailoring)
            </summary>
            <textarea
